...
public class IVChangesTests {
 ...
 private static LibertyServer server = LibertyServerFactory.getLibertyServer("com.ibm.ws.security.token.ltpa.fat.IVChangesTestServer");
 ...
 @BeforeClass
    ...
    public void testReplacingValidationKeyWithLTPAKeyFromServer1() throws Exception {
        ...
        copyFileToServerResourcesTmpdir(server2, DEFAULT_KEY_PATH_SERVER1 );
