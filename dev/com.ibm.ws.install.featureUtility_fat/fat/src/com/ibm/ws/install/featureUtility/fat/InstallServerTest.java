...
public class InstallServerTest extends FeatureUtilityToolTest {
	...
	/**
	 * Test install with a malformed server.xml
	 */
	@Test
	public void testMalformedServerInstall() throws Exception {
		String METHOD_NAME = "testMalformedServerInstall";
		Log.entering(c, METHOD_NAME);

		copyFileToMinifiedRoot("usr/servers/serverX", "publish/tmp/malformedServerInstall/server.xml");
		String[] param2s = { "installServerFeatures", "serverX", "--verbose" };

		ProgramOutput po = runFeatureUtility(METHOD_NAME, param2s);
		String output = po.getStdout();

		checkCommandOutput(po, 25, "CWWKF1241E", null); // com.ibm.ws.kernel.boot.ReturnCode.RUNTIME_EXCEPTION
	 ...
	 */
	@Test
	public void testServerWithIncludeFail() throws Exception {
		String METHOD_NAME = "testServerWithIncludeFail";
		Log.entering(c, METHOD_NAME);

		copyFileToMinifiedRoot("usr/servers/serverX", "publish/tmp/serverWithIncludeFail/server.xml");
		String[] param2s = { "installServerFeatures", "serverX", "--verbose" };
	 ...
	 */
	@Test
	public void testServerWithIncludeOptional() throws Exception {
		String METHOD_NAME = "testServerWithIncludeOptional";
		Log.entering(c, METHOD_NAME);

		copyFileToMinifiedRoot("usr/servers/serverX", "publish/tmp/serverWithIncludeOptional/server.xml");
		String[] param2s = { "installServerFeatures", "serverX", "--verbose" };
	 ...
	 */
	@Test
	public void testServerWithIncludeSuccess() throws Exception {
		String METHOD_NAME = "testServerWithIncludeSuccess";
		Log.entering(c, METHOD_NAME);

		copyFileToMinifiedRoot("usr/servers/serverX", "publish/tmp/serverWithIncludeSuccess/server.xml");
		copyFileToMinifiedRoot("usr/servers/serverX", "publish/tmp/serverWithIncludeSuccess/included.xml");
		String[] param2s = { "installServerFeatures", "serverX", "--verbose" };
	...
	public void testInstallAutoFeatureServerXml() throws Exception {
		...
		// String[] filesList = {
		// "/lib/features/com.ibm.websphere.appserver.eventLogging-1.0-osgiConsole-1.0.mf"
		// };
